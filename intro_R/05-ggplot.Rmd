...
```{r}
supers <- read_csv("super_data/heroes_information.csv")
...
lets test out a scatter plot, by choosing a continuous variable for both the weights and height. note that the aesthetic for coloring the points is "color", not "fill"
...
Lets test out some plotting with our microbial abundance data
```{r}
