...
- in abundances, with tidyverse, taxonomy is in the first column. with base R taxonomy becomes the rownames, and taxonomy has no column heading (because it is rownames)
- in covarriate, they appear to be the same!
...
covariates %>% 
  ...
  select(SampleName, Location) 
```

- does it matter if you use select or filter first?

yes! if you select only sample name and location, the season column doesnt exist anymore! so you'll have to filter first :) 
